<?php
	...
	class Browser {
        ...
        const OPERATING_SYSTEM_MAC_OS = 'Mac OS';
		const OPERATING_SYSTEM_IPHONE_OS = 'iPhone OS';
		
		
		
		private static $os_bit = array(
			'WOW64' => '64-bit',
			''      => '32-bit',
			);
		/**
		 ...
		 */
		private static $os_windows = array(
		...
		/**
		 * incomplete list of Linux distributions
		 */
		private static $os_linux = array(
			'Ubuntu' => 'Ubuntu',
			'Kubuntu' => 'Kubuntu',
			'SUSE' => 'SUSE',
			'Fedora' => 'Fedora',
		...
		*/
		public function toString() {
			...
			return  array('getBrowser' => $this->getBrowser() , 'getVersion' =>$this->getVersion() , 'getOs' => $this->getOs() );
			    	     	   
		}
		
			public function spString() {
			return "<strong>Browser Name:</strong>{$this->getBrowser()}<br/>\n" .
			       "<strong>Browser Version:</strong>{$this->getVersion()}<br/>\n" .

			       "<strong>Platform:</strong>{$this->getOs()}<br/>";
		}
		
			public function brw() {
			return "{$this->getBrowser()} " ."{$this->getVersion()} " ."( {$this->getOs()} )";
