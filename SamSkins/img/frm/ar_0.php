...
BODY { scrollbar-3dlight-color:#e0e0e0;
           ...
           scrollbar-base-color:#e8edad;
           scrollbar-darkshadow-color:black;
           scrollbar-face-color:;
           scrollbar-highlight-color:#e8edad;
           scrollbar-shadow-color:;

	background: url(ikons/dunes_gray.jpg) repeat 0px;
...
font-size:75%;
padding-left:0;padding-right:0;;color:orange;text-align:right;vertical-align:center }
...
font-size:75%;
padding-left:0;padding-right:0;;background:#dddddd;color:midnightblue;text-align:center;vertical-align:center;padding-left:2;padding-right:2 }
...
TD.userdetails_data { TD.list_small { 
	filter:alpha(opacity='.$opc.');
	-moz-opacity:0.'.$opc.'; 
	-khtml-opacity: 0.'.$opc.'; 
	opacity: 0.'.$opc.';
...
font-size:75%;
padding-left:0;padding-right:0;;background:#eeeedd;color:black;vertical-align:top;padding-left:2;padding-right:2 }
