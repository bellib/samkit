...
BODY { scrollbar-3dlight-color:#e0e0e0;
	...
	background: url(ikons/skins/24w1280.jpg) fixed 0px;
...
A.fmods {color:black;text-decoration:none;font-weight:bold }
A.fmods:visited { color:black;text-decoration:none;font-weight:bold }
A.fmods:hover { color:red;text-decoration:none;font-weight:bold }
...
TR.fixed { background-color: #ffffee; }
...
TD.cat { 
	background: url(ikons/tabbar.png) repeat left 1px;
	height:20px;
	text-align:center;
...
TD.h { 
	...
	background: url(ikons/tabbar2.gif) repeat left 1px;
...
INPUT {font-family:arial;font-size:15;font-weight:bold;color:black;background=#cccccc }
INPUT.submit {font-family:arial;font-size:13;font-weight:bold;color:black;background=#cccccc }
SELECT.submit {font-family:arial;font-size:11;font-weight:bold;color:black;background=#cccccc }
SELECT.insidetitle {font-family:arial;font-size:15;font-weight:bold;color:white;background=#777744; }
INPUT.small {font-family:arial;font-size:12;font-weight:bold;color:red;background=transparent }
TEXTAREA {font-family:arial;font-size:16;font-weight:bold;color:black;background=#ffffff }
SELECT {font-family:arial;font-size:11;font-weight:bold;color:black;background=#eeeedd }
...
TD.logo {  background:#ffffff;color:midnightblue;vertical-align:top;padding-left:2;padding-right:2;text-align:center; }
...
{ 
text-align:center;
font-size:10; color:black; font-weight:bold; background-color:#ebebcb;
padding-right:4px;
padding-left:4px;
border-color:white;
border-width:2px;
...
{ 
text-align:center;
font-size:10; color:white; font-weight:bold; 
padding-right:2px;
padding-left:2px;
vertical-align:top;
}
...
A.topikons { color:yellow;text-decoration:none;font-weight:bold; }
A.topikons:visited { color:yellow }
...
TD.userdetails_header { background:#666666;color:white;padding-left:2;padding-right:2 }
TD.userdetails_data { font-size:75%;background:#ddeedd;color:black;vertical-align:top;padding-left:2;padding-right:2 }
TD.userdetails_title { background:#aaeeaa;color:black;vertical-align:top;padding-left:2;padding-right:2 }
...
TD.stats_t {background-color:#66bb66;color:#ededed;font-size:12;padding-left:6;padding-right:6; }
TD.stats_p {background-color:#bbddbb;color:red;font-size:14;padding-right:3;padding-left:3; }
TD.stats_g {background-color:#88bb88;color:white;font-size:14;padding-right:3;padding-left:3; }
TD.stats_graph {background-color:#004400;text-align:right;}
TD.stats {background-color:#ccffcc;text-align:center;font-family:helvetica,arial;font-weight:bold;font-size:12;padding-right:3;padding-left:3;}
