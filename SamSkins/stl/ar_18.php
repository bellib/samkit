...
body{ scrollbar-3dlight-color:#e0e0e0;
	...
	background: url('.GURLGET.'sora/ikonzskins/g21) fixed 0px ;
...
TR.fixed { background-color: #DBFDD7; }
TR.deleted { background-color: #7facbf; }
TR.lastposter { background-color: #cccccc; }
TR.highlighted { background-color: #c2c2c2; }
 
TD { color:darkgreen;font-weight:bold;font-size:15px;font-family:Helvetica,Arial }
TD.cat { 
	background: #000000 url('.GURLGET.'sora/icons/ibg);
	height:20px;
	text-align:center;
...
img.samImg{border:1px solid #000;}
img.samImg:hover { border: 1px solid rgba(255, 255, 0, 0.12);background: url('.GURLGET.'sora/icons/ihover) fixed 0px ; } {
}
span.topicons{font-size:11px;text-align:center;color:black;}
TD.list { 
color:menutext;padding-left:2px;padding-right:2px;
...
TD.h { 
	...
	background: #000 repeat left 1px;
...
SELECT.insidetitle {font-family:arial;font-size:15px;font-weight:bold;color:white;background-color:#777744; }
INPUT.small {font-family:arial;font-size:12;font-weight:bold;color:red;background=transparent }
TEXTAREA {font-family:arial;font-size:16;font-weight:bold;color:black;background-color:#ffffff; resize: none; }
...
TD.f1 { background:#fff;color:#008600;vertical-align:top;padding-left:2px;padding-right:2px;
...
TD.f2ts { font-size:75%;background:#EFFFED;color:midnightblue;text-align:center;vertical-align:center;padding-left:2px;padding-right:2px;
	border-color:transparent;
	border-width:0px;
	border-style:solid;
     filter:alpha(opacity='.$opc.');
...
SELECT.forumSelect { font-size:10px;font-weight:bold;color:white;background-color:darkgreen; }
SELECT.timezoneSelect { font-size:10px;font-weight:normal;color:black;background-color:orange; }
...
A.topikons { color:#000044;text-decoration:none;font-weight:bold; }
A.topikons:visited { color:#000044 }
...
{ 
text-align:center;
font-size:11px; color:black; font-weight:bold; background-color:#ffeeee;
padding-right:2px;
padding-left:2px;
border-color:white;
border-width:2px;
