...
BODY { scrollbar-3dlight-color:#e0e0e0;
	...
	background: url(ikons/skins/14w1280.jpg) fixed 0px;
	background-color:#b8a3c4;
...
TR.fixed { background-color: #fbd1ff; }
...
{ 
text-align:center;
font-size:10; color:black; font-weight:bold; background-color:#feeffe;
padding-right:4px;
padding-left:4px;
border-color:white;
border-width:2px;
