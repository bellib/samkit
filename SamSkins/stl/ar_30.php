...
BODY { scrollbar-3dlight-color:#e0e0e0;
	...
	background: url(ikons/skins/30.jpg) 0px;
...
A.topikons { color:green;font-size:12px;text-decoration:none;font-weight:bold; }
A.topikons:visited { color:green;font-size:12px;font-weight:bold; }
