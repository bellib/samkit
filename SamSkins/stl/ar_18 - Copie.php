...
TR.fixed { background-color: #cbdee5; }
...
TD.f1 { background:#fff;color:midnightblue;vertical-align:top;padding-left:2;padding-right:2;
...
font-size: 10px;
text-align:center;
font-size:10; color:black; font-weight:bold; background-color:#e2eff5;
padding-right:4px;
padding-left:4px;
border-color:white;
border-width:2px;
