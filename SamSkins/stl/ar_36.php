...
BODY { scrollbar-3dlight-color:#e0e0e0;
	...
	background: url(ikons/skins/36w1024.jpg) fixed 0px;
...
TR.fixed { background-color: #a5bcb4; }
TR.deleted { background-color: #839fa0; }
...
A.topikons { color:#ffbbbb;text-decoration:none;font-weight:bold; }
A.topikons:visited { color:#ffbbbb }
A.topikons:hover { color:cyan }
